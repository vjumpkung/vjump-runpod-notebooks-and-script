...
cp --reflink=auto "$dit_low_path" ./diffusion_models/wan2.2_i2v_low_noise_14B_fp16.safetensors
...
cp --reflink=auto "$dit_high_path" ./diffusion_models/wan2.2_i2v_high_noise_14B_fp16.safetensors
